...
const OrderBook: React.FC = () => {
  const askOrders = [
    { price: 91.4, change: 2.9, volume: 10600 },
    { price: 91.4, change: 2.9, volume: 10600 },
    { price: 91.4, change: 2.9, volume: 10600 },
  ];
  ...
  return (
    <section className="flex overflow-hidden flex-col flex-1 p-2 w-full bg-gray-900 rounded">
      ...
      <div className="flex flex-col mt-3 w-full text-xs font-semibold leading-relaxed">
        <div className="flex overflow-hidden flex-col flex-1 w-full">
          ...
          <div className="flex flex-col mt-3 w-full text-rose-600 whitespace-nowrap">
            {askOrders.map((order, index) => (
              <div key={index} className="flex relative mt-1 w-full min-h-[20px]">
                <div className="flex absolute right-0 bottom-0 z-0 shrink-0 self-start h-5 rounded-sm bg-pink-950 min-w-[240px] w-[342px]" />
                <div className="z-0 flex-1 shrink my-auto basis-4">{order.price}</div>
                <div className="flex z-0 flex-1 shrink items-center py-2.5 h-full basis-4">
                  ...
                  />
                  <div className="self-stretch my-auto">{order.change}%</div>
                </div>
          ...
          <div className="flex flex-col mt-3 w-full text-green-500">
